...
def visibility_nwps(which_wilderness):
...
def visibility_capped(which_wilderness, cap_year):
    """ as above but capped at arbitrary year """
    ...
    if station.empty:
        log(slug_wilderness, None, "RED", str(which_wilderness) + " visibility empty")
        with uopen(empty_file_out, "a"):
            os.utime(empty_file_out, None)
    else:
        site = station["IMPROVE_SITE_CODE"].values[0]
        ...
        if datum.empty:
            log(
                slug_wilderness, "RED", str(which_wilderness) + " visibility data empty"
            )
            with uopen(empty_file_out, "a"):
                os.utime(empty_file_out, None)
        else:
            if not datum["x_total"].values[0] == datum["x"].values[0]:  # extended graph
                ...
                fig1.savefig(
                    ...
                    + slash
                    + slug_wilderness
                    + "-visibility-capped-graph-extended.png"
                )
                log(
                    slug_wilderness,
                    "GREEN",
                    slug_wilderness + "-visibility-capped-graph-extended.png saved",
                )
                fig1.clf()
                pyplot.clf()
                pyplot.cla()
            ...
            vis_minyr0 = vis_minyr + 5  # 5 per kdv
            vis_minyr5 = vis_minyr0 + 5
            vis_minyr6 = vis_minyr0 + 6
            vis_minyr7 = vis_minyr0 + 7
            vis_minyr8 = vis_minyr0 + 8
            vis_minyr9 = vis_minyr0 + 9
            vis_minyr10 = vis_minyr0 + 10
            vis_minyr11 = vis_minyr0 + 11
            vis_minyr12 = vis_minyr0 + 12
            vis_minyr13 = vis_minyr0 + 13
            vis_minyr14 = vis_minyr0 + 14
            vis_minyr15 = vis_minyr0 + 15
            vis_minyr20 = vis_minyr0 + 20
            vis_minyr25 = vis_minyr0 + 25
            vis_minyr30 = vis_minyr0 + 30
            ...
            if vis_minyr6 < vis_maxyr:
                vis6 = df[df.years_x.between(vis_minyr, vis_minyr6)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis6["years_x"], vis6["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr7 < vis_maxyr:
                vis7 = df[df.years_x.between(vis_minyr, vis_minyr7)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis7["years_x"], vis7["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr8 < vis_maxyr:
                vis8 = df[df.years_x.between(vis_minyr, vis_minyr8)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis8["years_x"], vis8["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr9 < vis_maxyr:
                vis6 = df[df.years_x.between(vis_minyr, vis_minyr9)]
                (
                    m,
                    b,
                    endy,
            ...
            if vis_minyr11 < vis_maxyr:
                vis11 = df[df.years_x.between(vis_minyr, vis_minyr11)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis11["years_x"], vis11["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr12 < vis_maxyr:
                vis12 = df[df.years_x.between(vis_minyr, vis_minyr12)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis12["years_x"], vis12["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr13 < vis_maxyr:
                vis13 = df[df.years_x.between(vis_minyr, vis_minyr13)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis13["years_x"], vis13["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            if vis_minyr14 < vis_maxyr:
                vis14 = df[df.years_x.between(vis_minyr, vis_minyr14)]
                (
                    m,
                    b,
                    endy,
                    ...
                    mkr_trend_text,
                    cols,
                ) = trender(vis14["years_x"], vis14["observations_y"])
                cols = pandas.DataFrame(
                    {
                        "years_x": cols[:, 0],
                        "observations_y": cols[:, 1],
            ...
            fig1.savefig(
                ...
                + slash
                + slug_wilderness
                + "-visibility-capped-graph-labels.png"
            )
            fig1.clf()
            pyplot.clf()
            pyplot.cla()
            ...
            log(
                ...
                slug_agency,
                "GREEN",
                slug_wilderness + "-visibility-capped-graph.png saved",
            )
